        ...
        function fillOutputStatisticsData(obj, resp) {
            ...
            for (let i = 0; i < resp.data.dynamics_chart_data[0].length; i++) {
                ...
                obj.model.outputStatisticsData.tableDynamicsData.push({
                    period: vm.statistics.menu.getMonthName(
            ...
            obj.pagination.rowCountPieTable = obj.model.outputStatisticsData.pieChartData.length;
            obj.pagination.rowCountDynamicsTable = obj.model.outputStatisticsData.tableDynamicsData.length;
            obj.pagination.countPerPage = obj.pagination.rowCountPieTable < 10 ? obj.pagination.rowCountPieTable : 10;
